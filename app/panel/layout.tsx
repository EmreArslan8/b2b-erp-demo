import { getCurrentProfile, getNotifications } from "../../lib/supabase/queries";
...
const navigation = [
  ...
  ["Envanter", [["/panel/urunler", "products", "Ürünler", "admin"], ["/panel/urunler/siralama", "sort", "Ürün Sıralaması", "admin"], ["/panel/stok", "warehouse", "Stok & Depo", "admin"]]],
  ["Yönetim", [["/panel/tedarikciler", "suppliers", "Tedarikçiler", "admin"], ["/panel/raporlar", "reports", "Raporlar", "admin"], ["/panel/gecmis", "history", "İşlem Geçmişi", "admin"], ["/panel/gorevler", "tasks", "Görevler", "sales"], ["/panel/ayarlar", "settings", "Ayarlar", "super_admin"]]],
] as const;
...
export default async function PanelLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <PanelShell navigation={visibleNavigation} roleLabel={roleLabel} notifications={notifications.data}>{children}</PanelShell>;
}
