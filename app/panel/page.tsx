...
export default async function PanelPage() {
  ...
  return (
    <section>
      ...
      <div className="stats">
        <div className="card stat"><div className="k">Bugünkü Sipariş</div><div className="v">{data.todayOrders}</div><div className="sub">Supabase verisi</div></div>
      ...
      <div className="card card-pad" style={{ marginTop: 14 }}>
        <h3>{data.connected ? "Supabase bağlantısı aktif" : "Supabase bağlantısı bekleniyor"}</h3>
        <p className="sub">{data.error ?? "Panel metrikleri gerçek Supabase tablolarından okunuyor."}</p>
