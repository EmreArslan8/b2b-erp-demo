...
export default async function StockPage() {
  ...
  return <section>
    <div className="section-head"><div><div className="crumb">Envanter</div><h2>Stok &amp; Depo</h2></div><div className="spacer" /><WarehouseManager warehouses={options.warehouses} createAction={createWarehouse} updateAction={updateWarehouse} /><StockMovementForm products={options.products} warehouses={options.warehouses} suppliers={options.suppliers} action={createStockMovement} /></div>
